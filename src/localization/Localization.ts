import { Language, MessagesDictType, MessagesNamespaces, regions, TranslationTree } from ".";
...
export class Localization<MessagesType extends MessagesDictType> extends EventsManager<EventType> {
  ...
  getLanguage() {
    ...
    const languages = new Set([
      ...this.parseLanguage(window.navigator.language),
      ...window.navigator.languages.flatMap(this.parseLanguage),
    ]);
